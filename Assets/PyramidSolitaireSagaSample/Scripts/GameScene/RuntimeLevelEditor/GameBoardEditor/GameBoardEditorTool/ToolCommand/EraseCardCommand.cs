...
{
    public class EraseCardCommand : BaseToolCommand, IGameBoardToolCommand
    {
        public EraseCardCommand(GameBoardEditorPresenter gameBoardEditorPresenter) : base(gameBoardEditorPresenter)
        {
        }

        public void LeftTap()
        {
            CardModel = _gameBoardEditorPresenter.DeselectCardAndRemoveCard();
